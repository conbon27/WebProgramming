...
var item = document.getElementById("juni");
item.addEventListener("mouseover", func, false);
item.addEventListener("mouseout", func1, false);

function func()
{   
   document.getElementById("junior").setAttribute("display:block;")
}

function func1()
{  
    document.getElementById("junior").setAttribute("display:none;")
}
